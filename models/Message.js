...
var articleAndComment = new Schema({
    articleId:{type:Schema.Types.ObjectId,ref:'articles'},//文章ID eh
    content:String,//评论内容 he
    userId:{type:Schema.Types.ObjectId,ref:'customs'},//用户ID eh
    replay:String,//回复内容 h
    commentId:{type:Schema.Types.ObjectId,ref:'articleComment'},//评论ID eh
})
